...
const CardComponent: React.FC<CardComponentProps> = ({
  ...
  return (
    <div className='relative flex items-center justify-center rounded-xl border border-gray-900 bg-gray-950 px-8 py-32'>
      <Link
        href={`/${slug}`}
      ...
      <div className='z-0 [&>button]:w-40 [&>div]:w-40 [&>input]:w-40'>
        {children}
      </div>
    </div>
  );
